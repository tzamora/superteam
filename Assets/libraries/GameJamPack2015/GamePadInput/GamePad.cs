...
namespace GamepadInput
{
    ...
    public static class GamePad
    {
        ...
        public enum Button { A, B, Y, X, RightShoulder, LeftShoulder, RightStick, LeftStick, Back, Start, LeftPad, RightPad }
        ...
        static KeyCode GetKeycode(Button button, Index controlIndex)
        {
			switch (controlIndex)
            {
                    ...
                    switch (button)
				{
						...
						case Button.LeftPad : return KeyCode.Joystick1Button7;
						case Button.RightPad : return KeyCode.Joystick1Button8;
                    }
                    break;
                case Index.Two:
                    switch (button)
